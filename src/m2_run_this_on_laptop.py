...
def sprint3():
    ...
    teleop_frame, exit_frame = get_shared_frames(main_frame, mqtt_sender)

    # -------------------------------------------------------------------------
    # Grid the frames.
    # -------------------------------------------------------------------------
    grid_frames3(name_frame, control_frame, teleop_frame, exit_frame)
    # -------------------------------------------------------------------------
    # The event loop:
    # -------------------------------------------------------------------------
    root.mainloop()
def get_control_frame(window, sender):
    ...
    make_fun = ttk.Button(frame, text="Joke with resident")
...
def get_name_frame(window, sender):
    ...
    return frame
def grid_frames3(title_frame, control_frame, tele_frame, exit_frame):
    title_frame.grid(row = 0, column = 0)
    control_frame.grid(row = 1, column = 0)
    tele_frame.grid(row = 2, column = 0)
    exit_frame.grid(row = 3, column = 0)
