...
def jacob_pickup_object_using_proximity_sensor(window,sender):
    frame = ttk.Frame(window, padding=10, borderwidth=5, relief="ridge")
...
def jacob_spin_pickup_object(window,sender):
    frame = ttk.Frame(window, padding=10, borderwidth=5, relief="ridge")
    frame.grid(row=3, column=1)
    frame_label = ttk.Label(frame, text='Spin Then Pickup')
    frame_label.grid(row=0, column=0)
